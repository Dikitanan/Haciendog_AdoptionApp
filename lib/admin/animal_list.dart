                                ...
                                child: Padding(
                                  ...
                                  child: DataTable(
                                    ...
                                    columns: const [
                                      ...
                                      DataColumn(
                                        label: Center(child: Text('Pet Name')),
                                        tooltip: 'Pet Name',
                                        numeric: false,
                                      ),
                                      DataColumn(
                                      ...
                                      DataColumn(
                                        label: Center(
                                            child: Text('Age on Shelter')),
                                        tooltip: 'Age on Shelter',
                                        numeric: false,
                                      ),
                                      DataColumn(
                                        label:
                                            Center(child: Text('Personality')),
                                        tooltip: 'Personality',
                                        numeric: false,
                                      ),
                                      DataColumn(
                                      ...
                                      DataColumn(
                                        label: Center(child: Text('PWD')),
                                        tooltip: 'PWD',
                                        numeric: false,
                                      ),
                                      DataColumn(
                                        label:
                                            Center(child: Text('Cat or Dog')),
                                        tooltip: 'Cat or Dog',
                                        numeric: false,
                                      ),
                                      DataColumn(
                                    ...
                                    rows:
                                        _filteredAnimals(animals).map((animal) {
                          ...
                          : Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  var animal = _filteredAnimals(animals)[index];
                                  return Card(
                                    elevation: 4,
